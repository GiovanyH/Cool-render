...
int main()
{
    ...
    // ------------------------------------
    Shader heightMapShader("shaders/cpu_height.vs","shaders/cpu_height.fs");
    ...
    unsigned char *data = stbi_load("resources/heightmaps/RuggedTerrainHeightMap.png", &width, &height, &nrChannels, 0);
    if (data)
    {
